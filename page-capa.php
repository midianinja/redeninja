...
<div id="main-content">
	...
	<article id="post-61" class="post-61 page type-page status-publish hentry">
		...
		<div class="entry-content">
			...
			$string .= '[/et_pb_row][/et_pb_section]';
			echo do_shortcode($string);
			?>
		</div> <!-- .entry-content -->
